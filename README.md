...
> `https://github.com/CharlieKarafotias/kickstart.nvim.git`
...
> `nvim-lua` with `CharlieKarafotias` in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/CharlieKarafotias/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/CharlieKarafotias/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/CharlieKarafotias/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
